...
//additional steps for number of games (my additions)
...
const displayStr = 
`$${totalRaised} has been funded for ${totalGames - numUnfundedGames} games. Currently, ${numUnfundedGames == 1 ? 
    "1 game remains unfunded." : numUnfundedGames + " games remain unfunded. We need your help to earn this funding!"}`;
